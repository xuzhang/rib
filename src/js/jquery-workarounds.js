...
/*
 * FIXME: This is a workaround for a flaw in j plugin
 *        for sortable widget
 *
 * We override the _contactContainers function so that it can trigger rearrange
 * placeholder correctly even if current item is just out of the inner container, but it is
 * placeholder still in original container.
 *
 * Copied from jquery-ui version 1.8.16, ui/jquery.ui.sortable.js
 */
    ...
    _contactContainers: function(event) {
        ...
        if(this.containers.length === 1) {
            ...
            this.containers[innermostIndex].containerCache.over = 1;
                ...
                // ) {
                // This is our line
                || this.containers[innermostIndex].element.find(this.placeholder).length === 0) {
                /////////////////////////////////////////////////////////////////
                // End of our changes
